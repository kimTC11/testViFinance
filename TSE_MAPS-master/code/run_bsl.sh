mode=gpt_bsl_ape # Your mode name should contain one keyword from ape, opro, evol_de and, evol_ga
...
python auto_prompt_bsl.py --seed_number 5 --iteration_number 4 --max_test_cases 5 --generated_number 2 \
                                --mode $mode --model_name $model_name --output_base_dir $output_base_dir \
                                --data_dir /data/ubuntu/ut_gen/data/sample_bsl.jsonl \
                                --test_data_dir /data/ubuntu/ut_gen/data/all_bsl.jsonl \
